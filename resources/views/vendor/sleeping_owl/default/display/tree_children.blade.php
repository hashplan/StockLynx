        ...
        <div class="dd3-content">
            ...
            <div class="pull-right">
                @if(is_a($entry, 'App\Model\RosettaTree'))
                    ...
                    <div class="modal fade" id="node_{{$entry->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title" id="myModalLabel"> {{{ $entry->$value }}}</h4>
                                </div>
            ...
            @foreach(App\Model\ValuationTree::byNode($entry->id)->get() as $valuation)
                    <li class="list-group-item">
                        ...
                        <div class="modal fade" id="valuation_{{$valuation->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel"> {{{ $valuation->scenario_name }}}</h4>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
